...
type PreviewTripRequest struct {
	...
	// Unique identifier of the rider requesting trip preview.
	UserId string `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	// Trip origin coordinate selected by the rider.
	...
	// Trip destination coordinate selected by the rider.
...
type PreviewTripResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Server-generated identifier for the previewed trip.
	TripId string `protobuf:"bytes,1,opt,name=trip_id,json=tripId,proto3" json:"trip_id,omitempty"`
	// Computed route metadata and geometry between start and end points.
	Route *Route `protobuf:"bytes,2,opt,name=route,proto3" json:"route,omitempty"`
	// List of fare estimates grouped by supported ride package.
...
type Route struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Ordered route geometry chunks returned by routing provider.
...
type RideFare struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Unique fare identifier for this package estimate.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// Rider identifier associated with this fare estimate.
	UserId string `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	// Package slug (for example, economy, comfort) used by clients.
	PackageSlug string `protobuf:"bytes,3,opt,name=package_slug,json=packageSlug,proto3" json:"package_slug,omitempty"`
	// Final estimated price in cents.
...
type Geometry struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Ordered coordinate list describing the route segment path.
...
const file_trip_proto_rawDesc = "" +
	...
	"\x14total_price_in_cents\x18\x04 \x01(\x01R\x11totalPriceInCents\">\n" +
	"\bGeometry\x122\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	4, // 3: trip.PreviewTripResponse.ride_fares:type_name -> trip.RideFare
